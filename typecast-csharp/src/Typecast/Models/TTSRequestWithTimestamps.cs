...
/// <summary>
/// Request model for Text-to-Speech synthesis with word/character timestamp alignment.
/// </summary>
public class TTSRequestWithTimestamps
{
    ...
    /// <summary>
    /// Creates a new empty TTSRequestWithTimestamps.
    /// </summary>
    public TTSRequestWithTimestamps() { }

    /// <summary>
    /// Creates a new TTSRequestWithTimestamps with required parameters.
    /// </summary>
    /// <param name="text">The text to synthesize</param>
    /// <param name="voiceId">The voice ID to use</param>
    /// <param name="model">The TTS model to use</param>
    public TTSRequestWithTimestamps(string text, string voiceId, TTSModel model)
    {
        Text = text;
        VoiceId = voiceId;
        Model = model;
