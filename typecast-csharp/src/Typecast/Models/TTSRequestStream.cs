...
public class TTSRequestStream
{
    ...
    /// <summary>
    /// Streaming audio output configuration (optional).
    /// </summary>
    [JsonPropertyName("output")]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    public OutputStream? Output { get; set; }
    ...
    /// <summary>
    /// Creates a new empty TTSRequestStream.
    /// </summary>
    public TTSRequestStream() { }

    /// <summary>
    /// Creates a new TTSRequestStream with required parameters.
    /// </summary>
    /// <param name="text">The text to synthesize</param>
    /// <param name="voiceId">The voice ID to use</param>
    /// <param name="model">The TTS model to use</param>
    public TTSRequestStream(string text, string voiceId, TTSModel model)
    {
        Text = text;
        VoiceId = voiceId;
        Model = model;
