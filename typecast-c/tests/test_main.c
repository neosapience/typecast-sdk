...
TEST(version) {
    ...
    ASSERT_STREQ(TYPECAST_VERSION, EXPECTED_TYPECAST_VERSION);
    ASSERT_EQ(TYPECAST_VERSION_MAJOR, EXPECTED_TYPECAST_VERSION_MAJOR);
    ASSERT_EQ(TYPECAST_VERSION_MINOR, EXPECTED_TYPECAST_VERSION_MINOR);
    ASSERT_EQ(TYPECAST_VERSION_PATCH, EXPECTED_TYPECAST_VERSION_PATCH);
    TEST_PASS();
}
